         ...
         "columnDefs": [
            {
                ...
                "render": function ( data, type, row ) {              
                    return '<a href="#" id="'+row.id+'" url="/sfm/deleteuser/'+row.id+'" class="deleteButton"><img src="images/vcard_delete.png" title="Delete User"/></a>&nbsp;<a href=edituser/'+row.id+'><img src="images/vcard_add.png" title="Edit User"/></a>';
                },
                "targets": 4
            }]         
	});	
